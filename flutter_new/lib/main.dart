...
import 'package:flutter_new/test.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    onTap: (values) {
    _selectedAnimals4 = values.cast<Animal>();
    },
    ...
    MaterialPageRoute(
    builder: (context) => Test(title: 'fff',),
    )
    );
